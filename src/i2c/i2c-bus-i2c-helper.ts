...
//  */
// export class I2CBusI2CHelper implements I2CHelper {
//   private i2c: I2CBus;
...
//     this.i2c.i2cWriteSync(deviceAddr, 1, this.regBuffer);
//     Utils.usleep(10);
//     // set register to read
//     this.i2c.i2cReadSync(deviceAddr, byteCnt, this.dataBuffer)
...
//     // write to register
//     this.i2c.i2cWriteSync(deviceAddr, 2, this.dataBuffer);
//     return I2C_SUCCESS;
//   }
...
//     this.i2c.i2cWriteSync(deviceAddr, data.length+1, this.dataBuffer)
//     return I2C_SUCCESS;
//   }
...
//     // write to register
//     this.i2c.i2cWriteSync(deviceAddr, 3, this.dataBuffer);
//     return I2C_SUCCESS;
//   }
// }
